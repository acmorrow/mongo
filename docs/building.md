...
For detailed information about building, please see [the build
manual](https://github.com/mongodb/mongo/wiki/Build-Mongodb-From-Source),
though be aware that that document often lags behind this one.
