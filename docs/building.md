...
Please note that prebuilt binaries are available on [mongodb.org](http://www.mongodb.org/downloads) and may be the easiest way to get started, rather than building from source.
...
Installing the requirements inside a virtualenv dedicated to building MongoDB is recommended.
...
For detailed information about building, please see [the build manual](https://github.com/mongodb/mongo/wiki/Build-Mongodb-From-Source), though be aware that that document often lags behind this one.
