...
add_option( "disable-minimum-compiler-version-enforcement",
            "allow unsupported use of unsupported older compilers (NEVER for production builds)",
            0, False )
...
def doConfigure(myenv):
    ...
    if not (c_compiler_validated and cxx_compiler_validated):
        print("WARNING: C and/or C++ compiler does not meet minimum version requirements")
